package megvii.facepass.ruitong;
...
public class FaceInit {
    ...
    public void initFacePass(){
        ...
        try {
            ...
            initFacePassSDK(a1,a2,a3,"",1,null);
    ...
    private static void initFacePassSDK(String s1,String s2,String s3,String id,int type,String url) {
    ...
    public void init(String registration,String url){
        ...
        link_uplodexiazai(registration,url);

    }

    //绑定
    private void link_uplodexiazai(String zhucema, final String url){
...
//				.header("user-agent","Koala Admin")
              ...
              //  Log.d("AllConnects", "请求成功"+call.request().toString());
                ...
                try{
                   ...
                   // Log.d("AllConnects", "注册码"+ss);
                    ...
                    link_bangding(idid,url+urlurl,url);
    ...
    //绑定设备
    private static void link_bangding(String id, final String url,final String url2){
        //	final MediaType JSON=MediaType.parse("application/json; charset=utf-8");
        OkHttpClient okHttpClient= new OkHttpClient();
        //RequestBody requestBody = RequestBody.create(JSON, json);
        RequestBody body = new FormBody.Builder()
...
//                        Log.d("MyReceiver", e.getMessage()+"gggg");
                    ...
                    try {
                        ...
                        initFacePassSDK(a1,a2,a3,dingBean.getId(),2,url2);
    ...
    //提交绑定状态
    private static void link_uplodeBangDing(String id,String url){
...
//					final HuiYiInFoBean renShu=gson.fromJson(jsonObject,HuiYiInFoBean.class);
                    ...
                    EventBus.getDefault().post("绑定设备异常");
                    Log.d("WebsocketPushMsg", e.getMessage()+"ttttt");
                }
